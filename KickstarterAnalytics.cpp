...
void printProject(const KickstarterProject& project) {
    ...
    cout << "Launch Year: " << project.launched_yr << endl;
    cout << endl;
}
...
void displayMenu() {
    cout << "Menu:" << endl;
    cout << "1. Success Rate" << endl;
    cout << "2. Top Funded Projects" << endl;
...
int main() {
 ifstream file("/Users/anannyaumesh/Desktop/DSA FINAL/ks2018projects (1).csv");
